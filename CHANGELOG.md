...
- 天气详情参数迁移至多日预报下方，6卡片矩阵排列，新增气压和能见度

## [1.9.60] - 2026-06-04

- 详情卡片方形等大、气压单位百帕、矩阵间距统一
...
- 详情卡片添加图标：紫外线/体感/湿度/风力/气压/能见度

## [1.9.67] - 2026-06-04

- 详情卡片三行布局：图标(24dp)/标签/数据居中排列
...
- 详情卡片标签字号 labelSmall→labelMedium
...
- 删除设置页底部冗余文字（数据来源已迁移至主页）

## [1.9.75] - 2026-06-04

- 设置页恢复QQ群和版本号，仅删除数据来源
...
- 设置页加navigationBarsPadding，删除多余底部Spacer

## [1.9.78] - 2026-06-04

- 定位改为优先显示最近特征地点，不再匹配大厦/广场关键词

## [1.9.80] - 2026-06-05

- 修复定位名称跳变：同地点200米内复用缓存名称
